...
export const UNSTOPPABLE_CE: Course = {
  ...
  about: [
    'A live online session you book, followed by a short evaluation and your certificate.',
...
export const UNSTOPPABLE_EXPERIENCE: Course = {
  ...
  about: [
    ...
    'Open to everyone, and held virtually so you can join from wherever you are. You can keep your camera off and stay quiet the whole time.',
  ],
  objectives: [
    'Name what you are carrying, in your own words, in a room where that is safe.',
    'Practice three tools you can use on your own afterwards: One Good Thing, box breathing, and the I Am, I Have, I Can affirmation.',
...
export const CMHW_FACILITATOR: Course = {
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            'Social workers',
            'HMC volunteers',
            'Anyone interested in mental health facilitation and education, at HMC or any other community organization',
          ],
        },
        {
          kind: 'list',
          ...
          items: [
            ...
            'Addressing systemic barriers to care, particularly for historically marginalized groups.',
        ...
        },
        {
          ...
          items: [
            ...
            'The certificate recognizes you as prepared to lead this work.',
          ],
        },
      ],
    },
  ...
  furtherLearning: [
    ...
    { name: 'National Alliance on Mental Illness (NAMI)', use: 'Peer-led support groups and education programs to refer participants to, and the source for the misdiagnosis findings taught in Module 1.', url: 'https://www.nami.org/' },
 ...
 *
 * The Experience first, because it is open to anyone, needs nothing, and is how almost
