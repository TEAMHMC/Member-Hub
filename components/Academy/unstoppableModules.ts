...
export const UNSTOPPABLE_MODULES: UnstoppableModule[] = [
    ...
    blocks: [
      ...
      },
      {
        ...
        text: [
          ...
          'That produces coping behaviors: overworking to prove worth, a push-through mindset.',
          'Those behaviors carry health risks: burnout, anxiety, depression.',
      ...
      },
      {
        ...
        prompts: [
          'Which of the two coping patterns above do you recognize in yourself?',
      ...
      },
      {
        ...
        check: {
          ...
          answer: 2,
          rationale:
            'The model runs stressor, cultural reinforcement, coping behaviors, health risks, with validation as the protective factor set against them. It is the one element in the chain a community can supply directly, which is why Module 4 exists.',
          distractors:
...

  {
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          { label: 'Start with empathy, not advice', text: 'Focus on listening without judgment or trying to fix someone immediately. Sometimes being heard is the healing.' },
      ...
      },
      {
        ...
        check: {
          ...
          answer: 2,
          rationale:
            'Start with empathy, not advice. Focus on listening without judgment or trying to fix someone immediately. Sometimes being heard is the healing.',
          distractors:
...

  {
    ...
    summary:
      'The national and local organizations to route people to, including those built specifically for Black communities.',
    minutes: 8,
    blocks: [
      {
        kind: 'list',
      ...
      },
      {
        ...
        text: [
          ...
          'HMC’s own directory holds vetted LA County organizations by need, area and who they serve. Search it for the two or three you expect to be asked for most, and know their numbers before the session.',
        ],
      },
      {
        kind: 'takeaways',
